...
\candidate{Nusrat Begum} % your name (without title)

\candidatetitle{Ms.\ } % Mr.\ Miss.\ or Ms.\
...
\majoradvisortitle{Asst.~Prof.~} % Dr.~ or Asst.~Prof.~ or Assoc.~Prof.~ or Prof.~
...
% Co-advisor removed from committee listing per requested change
\coadvisor{Suppawong Tuarob} % name of co-advisor
...
\programchair{Assoc.~Prof.~Boonsit Yimwadsana} % chair of your degree program
...
% Default: previous dean entry replaced with Deputy Dean / Acting Dean per request
\graduatestudiesdean{Assistant Professor Dr.Warin Krityakiarana\\Deputy Dean for Planning and Quality Assurance\\Acting as Dean of the Faculty of Graduate Studies, Mahidol University}
...
\submissiondate{February 2026} % date of submission

\chair{Assistant Professor Dr. Akara Supratak}
...
\facultydean{Dr.~Pattanasak Mongkolwat}    % default is Prof.~Prasert Sobhon
...
\candidatenumber{ 6638009 ITCS/M}
%\major{} % major of thesis (not necessary if the same as subject)
\keywords{DRIFT DETECTION / ADVERSARIAL VALIDATION /} % 1st line of keywords
\keywordsII{COVARIATE DRIFT / MLOPS / DISTRIBUTION SHIFT /} % 2nd line of keywords
\keywordsIII{STREAMING DATA} % 3rd line of keywords

% information for page v (THAI ABSTRACT)

\thaisubject{วิทยาการคอมพิวเตอร์} % thai name of degree subject
\thaititle{ชื่อภาษาไทย} % title of thesis in thai
\thaicandidate{นายชื่อ นามสกุล} % your name in thai
\thaimajoradvisor{ผศ. ดร. ธนพล นรเสฏฐ์} % Thai name of advisor (if they are Thai)
...
\dateofbirth{21 February 1998} % your date of birth
\placeofbirth{Chattogram, Bangladesh} % province and country of birth
\firstdegreeinstitution{Stamford International University} % where you did your first degree
\firstdegreeyears{2017--2022} % years for 1st degree
\firstdegree{Bachelor of Business Administration (International Business Management)} % updated degree title
...
%\homeaddressLnII{}
%\homeaddressLnIII{}
\email{nusrat.beg@student.mahidol.edu} % the email address at which you can be contacted after you have left
