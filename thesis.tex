...
\begin{figure}[!htpb]
    ...
    \caption{Overview of Explainable Adversarial Drift Detection (EADD) methodology. The framework extends adversarial validation with SHAP-based root cause analysis and automated prescriptions.}
